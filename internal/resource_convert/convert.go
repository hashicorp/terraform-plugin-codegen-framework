...
func (c converter) ToGeneratorResourceSchema() (map[string]generatorschema.GeneratorSchema, error) {
	resourceSchemas := make(map[string]generatorschema.GeneratorSchema, len(c.spec.Resources))
