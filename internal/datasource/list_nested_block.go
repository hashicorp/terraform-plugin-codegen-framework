...
func NewGeneratorListNestedBlock(b *datasource.ListNestedBlock) (GeneratorListNestedBlock, error) {
	if b == nil {
	...
	for _, v := range b.NestedObject.Attributes {
		...
		default:
			return GeneratorListNestedBlock{}, fmt.Errorf("attribute type is not defined: %+v", v)
		}
	...
	for _, v := range b.NestedObject.Blocks {
		...
		default:
			return GeneratorListNestedBlock{}, fmt.Errorf("block type is not defined: %+v", v)
		}
