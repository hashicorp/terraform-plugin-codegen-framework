...
func convertListNestedBlock(b *provider.ListNestedBlock) (provider_generate.GeneratorListNestedBlock, error) {
	...
	for _, v := range b.NestedObject.Attributes {
		...
		default:
			return provider_generate.GeneratorListNestedBlock{}, fmt.Errorf("attribute type is not defined: %+v", v)
		}

		if err != nil {
			return provider_generate.GeneratorListNestedBlock{}, err
		}
	...
	for _, v := range b.NestedObject.Blocks {
		...
		default:
			return provider_generate.GeneratorListNestedBlock{}, fmt.Errorf("block type is not defined: %+v", v)
		}
	...
	return provider_generate.GeneratorListNestedBlock{
