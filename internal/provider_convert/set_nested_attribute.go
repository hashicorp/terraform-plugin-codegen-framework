...
func convertSetNestedAttribute(a *provider.SetNestedAttribute) (provider_generate.GeneratorSetNestedAttribute, error) {
	...
	for _, v := range a.NestedObject.Attributes {
		...
		default:
			return provider_generate.GeneratorSetNestedAttribute{}, fmt.Errorf("attribute type not defined: %+v", v)
		}

		if err != nil {
			return provider_generate.GeneratorSetNestedAttribute{}, err
		}

		attributes[v.Name] = attribute
	}

	return provider_generate.GeneratorSetNestedAttribute{
