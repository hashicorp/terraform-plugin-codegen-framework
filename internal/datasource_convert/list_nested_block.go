...
func convertListNestedBlock(b *datasource.ListNestedBlock) (datasource_generate.GeneratorListNestedBlock, error) {
	if b == nil {
		return datasource_generate.GeneratorListNestedBlock{}, fmt.Errorf("*datasource.ListNestedBlock is nil")
	}
	...
	for _, v := range b.NestedObject.Attributes {
		...
		default:
			return datasource_generate.GeneratorListNestedBlock{}, fmt.Errorf("attribute type is not defined: %+v", v)
		}

		if err != nil {
			return datasource_generate.GeneratorListNestedBlock{}, err
		}
	...
	for _, v := range b.NestedObject.Blocks {
		...
		default:
			return datasource_generate.GeneratorListNestedBlock{}, fmt.Errorf("block type is not defined: %+v", v)
		}
	...
	return datasource_generate.GeneratorListNestedBlock{
