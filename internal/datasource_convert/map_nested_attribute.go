...
func convertMapNestedAttribute(a *datasource.MapNestedAttribute) (datasource_generate.GeneratorMapNestedAttribute, error) {
	if a == nil {
		return datasource_generate.GeneratorMapNestedAttribute{}, fmt.Errorf("*datasource.MapNestedAttribute is nil")
	}
	...
	for _, v := range a.NestedObject.Attributes {
		...
		default:
			return datasource_generate.GeneratorMapNestedAttribute{}, fmt.Errorf("attribute type not defined: %+v", v)
		}

		if err != nil {
			return datasource_generate.GeneratorMapNestedAttribute{}, err
		}

		attributes[v.Name] = attribute
	}

	return datasource_generate.GeneratorMapNestedAttribute{
