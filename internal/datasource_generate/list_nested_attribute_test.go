...
func TestGeneratorListNestedAttribute_GeneratorAttrType(t *testing.T) {
	t.Parallel()

	testCases := map[string]struct {
		input         GeneratorListNestedAttribute
		expected      GeneratorAttrType
		expectedError error
	}{
		"all": {
			input: GeneratorListNestedAttribute{
					...
					ElemType: GeneratorAttrType{
						types.ObjectType{
							AttrTypes: map[string]attr.Type{
								"bool": GeneratorAttrType{
									types.BoolType,
								},
								"float64": GeneratorAttrType{
									types.Float64Type,
								},
								"int64": GeneratorAttrType{
									types.Int64Type,
								},
								"list": GeneratorAttrType{
									types.ListType{
										ElemType: GeneratorAttrType{
											types.BoolType,
										},
								...
								"list_nested_attribute": GeneratorAttrType{
									types.ListType{
										ElemType: GeneratorAttrType{
											types.ObjectType{
												AttrTypes: map[string]attr.Type{
								...
								"number": GeneratorAttrType{
									types.NumberType,
								},
								"object": GeneratorAttrType{
									types.ObjectType{
										AttrTypes: map[string]attr.Type{
											"bool": GeneratorAttrType{
												types.BoolType,
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, err := testCase.input.GeneratorAttrType()
...
func TestGeneratorListNestedAttribute_ModelObjectHelpersString(t *testing.T) {
	t.Parallel()
...
"bool_nested": types.BoolType,
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, err := testCase.input.ModelObjectHelpersString("example")
